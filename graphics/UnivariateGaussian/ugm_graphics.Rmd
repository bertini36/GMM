...
data <- read.csv(paste(path, "timing/UnivariateGaussian/csv/ugm_times.csv", sep=""), header=TRUE, sep=";")
View(data)
x <- data$Dataset.size[data$Inference.type == "coordAsc/ugm_cavi"]

# Time comparison graphic
y1 <- data$Time[data$Inference.type == "coordAsc/ugm_cavi"]
y2 <- data$Time[data$Inference.type == "gradAsc/ugm_gavi"]
...
y1 <- data$Iterations[data$Inference.type == "coordAsc/ugm_cavi"]
y2 <- data$Iterations[data$Inference.type == "gradAsc/ugm_gavi"]
...
y1 <- data$ELBO[data$Inference.type == "coordAsc/ugm_cavi"]
y2 <- data$ELBO[data$Inference.type == "gradAsc/ugm_gavi"]
